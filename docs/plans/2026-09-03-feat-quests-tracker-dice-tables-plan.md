...
- [ ] The tracker, the dice tray, and the table roller are all reachable from the Run screen without leaving it.
- [ ] A member of campaign A gets 404 on an encounter or table URL in campaign B.
